...
def data(path):
    ...
    data.drop(columns='样本id', inplace=True)
    #绝大多数数据为空
    ...
    #值基本都是相同
    data.drop(columns='A1', inplace=True)
    data.drop(columns='A4', inplace=True)
    data.drop(columns='A13', inplace=True)
    data.drop(columns='A18', inplace=True)
    data.drop(columns='A21', inplace=True)
    data.drop(columns='A22', inplace=True)
    data.drop(columns='A23', inplace=True)
    data.drop(columns='B2', inplace=True)
